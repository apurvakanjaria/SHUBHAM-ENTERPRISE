			...
			<div class="wrap-login100">
				<form class="login100-form validate-form">
					...
					<div class="wrap-input100 validate-input" data-validate = "Enter Company name">
                        <asp:TextBox ID="txtcname" CssClass="input100" placeholder="Enter Company name" runat="server"></asp:TextBox>
						<span class="focus-input100" data-placeholder="&#xf207;"></span>
					</div>

                    <div class="wrap-input100 validate-input" data-validate = "Enter Company Address">
                        <asp:TextBox ID="txtcadd"  CssClass="input100" placeholder="Enter Company Address" runat="server"></asp:TextBox>
						<span class="focus-input100" data-placeholder="&#xf207;"></span>
					</div>

                     <div class="wrap-input100 validate-input" data-validate = "Enter Company mobile number">
                        <asp:TextBox ID="cmno"  CssClass="input100" placeholder="Enter Company mobile number" runat="server"></asp:TextBox>
						<span class="focus-input100" data-placeholder="&#xf207;"></span>
					</div>
					
                    <div class="wrap-input100 validate-input" data-validate = "Enter Company Email-Id">
                        <asp:TextBox ID="txtcemail"  CssClass="input100" placeholder="Enter Company Email-Id" runat="server" ></asp:TextBox>
						<span class="focus-input100" data-placeholder="&#xf207;"></span>
					</div>

                    <div class="wrap-input100 validate-input" data-validate = "Enter Company Contact person name">
                        <asp:TextBox ID="txtccpname" Cssclass="input100" placeholder="Enter Company Contact person name" runat="server"></asp:TextBox>
						<span class="focus-input100" data-placeholder="&#xf207;"></span>
					</div>
                    
                    <div class="wrap-input100 validate-input" data-validate = "Enter Company Contact person mno.">
                        <asp:TextBox ID="txtccpno" Cssclass="input100" placeholder="Enter Company Contact person mno." runat="server"></asp:TextBox>
						<span class="focus-input100" data-placeholder="&#xf207;"></span>
					</div>

                    <div class="wrap-input100 validate-input" data-validate = "Enter Your Password">
                        <asp:TextBox ID="txtpass" TextMode="Password" Cssclass="input100" placeholder="Enter Your Password" runat="server"></asp:TextBox>
						<span class="focus-input100" data-placeholder="&#xf207;"></span>
					</div>

                    <div class="wrap-input100 validate-input" data-validate = "Re-enter Your Password">
                        <asp:TextBox ID="txtrepass" TextMode="Password" Cssclass="input100" placeholder="Re-enter Your  Password" runat="server"></asp:TextBox>
						<span class="focus-input100" data-placeholder="&#xf207;"></span>
					</div>
